...
public final class ExceptionalWrapper {
    ...
    /**
     * Turns a functional interface with exceptions into one that throws a {@link WrappedExceptionalException} if an exception of type {@link E} was thrown.
     *
     ...
     * @return a functional interface that throws a {@link WrappedExceptionalException} if an exception of type {@link E} was thrown
     */
    ...
    /**
     * Truns a functional interface with exceptions into one that throws a {@link WrappedExceptionalException} if an exception of type {@link E} was thrown.
     *
     * @param biConsumer functional interface with exceptions
